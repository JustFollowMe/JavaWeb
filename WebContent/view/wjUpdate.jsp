...
<html>
	<head>
		...
		function chkForm() {
			...
			var discribe = document.getElementById("discribeId").value;
			if (title == "" || title.length == 0) {
				document.all("title").focus();
				return false;
			} else if (discribe == "" || discribe.length == 0) {
				document.getElementById("discribeId").focus();
				return false;
			}
			return true;
		}
		...
		<table width="100%" align="center" class="table">
			...
			<table width="100%" align="center" class="table">
				...
				<tr>
					...
					<td>
						&nbsp;
						<textarea id="discribeId" name="discribe" cols="100" rows="15" ><%=ob.getDiscribe()%></textarea>
					</td>
				</tr>
				<tr>
					<td height="30" align="right">
